export const movieMock = {
  ...
  awards:
    'Top rated movie #1 | Nominated for 7 Oscars, 21 wins & 43 nominations total',
  ...
  tagline: null,
  keywords:
    'prison,based on the works of stephen king,escape from prison,voice over narration,friendship between men',
  keywordList: [
    'prison',
